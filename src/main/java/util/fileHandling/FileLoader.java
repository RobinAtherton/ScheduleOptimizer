...
import util.data.processing.XMLConverter;
...
public class FileLoader {
    ...
    private static final String[] SEMESTERS = {"I6"};

    //folder Paths
    private static String INPUT_PATH = "src/main/resources/util/data/input/";
    ...
    private static String FWPM_PATH = INPUT_PATH + "/fwpm/";
    ...
    private static void loadFiles() {
        ...
        names[0] = SUBJECTS_PATH;
        names[1] = LESSONS_PATH;
        names[2] = LECTURERS_PATH;
        names[3] = PREFEERENCES_PATH;
        names[4] = ROOMS_PATH;
        names[5] = SEMESTERS_PATH;
        names[6] = LESSON_COLLECTIONS_PATH;
