...
public class FileGenerator {
    ...
    //Filtered Methods
    public static void writeFilteredSemesters(String output, File input, String... semesters) throws IOException {
        writeFiltered(output, input, semesters);
    }

    public static void writeSemesterFilteredLessonCollections(String output, File input, String... semesters) throws IOException {
        writeFiltered(output, input, semesters);
    }
    ...
    public static void writeFilteredUKWLessons(String output, File input, String... semesters) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeFilteredGKWLessons(String output, File input, String... semesters) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeFilteredGroupedLessons(String output, File input, String... semesters) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeFilteredAltLessons(String output, File input, String... semesters) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeFilteredFWPMLessons(String output, File input, String... semesters) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    private static void writeFiltered(String output, File input, String[] semesters) throws IOException {
        File lessonCollectionsFile = input;
        BufferedReader reader = new BufferedReader(new FileReader(lessonCollectionsFile));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        readFile(reader, writer, line, semesters);
    }

    private static void readFile(BufferedReader reader, BufferedWriter writer, String line, String[] semesters) throws IOException {
        while (line != null) {
            for (String semester : semesters) {
    ...
    //Modfied Methods
    public static void writeModifiedUKWLessons(String output, File input) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeModifiedGKWLessons(String output, File input) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeModifiedGroupedLessons(String output, File input) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeModifiedAltLessons(String output, File input) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
    ...
    public static void writeModifiedFWPMLessons(String output, File input) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        BufferedWriter writer = new BufferedWriter(new FileWriter(output));
        String line = reader.readLine();
        while (line != null) {
